...
model_path = '/import/geb-experiments-archive/Alex/Joint/OlympicSports/VideoStory/KLIEPY/Model/';
if ~exist(model_path,'dir')
    mkdir(model_path);
end

perf_path = '/import/geb-experiments-archive/Alex/Joint/OlympicSports/VideoStory/KLIEPY/Perf/';
