...
weight_model_path = '/import/geb-experiments-archive/Alex/ImportanceWeighting/OlympicSports/KLIEP_X/Weight/';
            ...
            for lambdaS = Para.lambdaS_range
                for LatentDim = Para.LatentDim_range
                    for sigmaX = Para.sigma_range
                        ...
                        %% Load weight
                        weight_filepath = sprintf([weight_model_path,'Weight_trial-%d_embed-%s_sigma-%g_aug-1_norm-zscore_ccv.mat'],trial,Para.EmbeddingMethod,Para.sigmaX);
                        KLIEP_X = load(weight_filepath,'weight');
                        weight = KLIEP_X.weight;
                        %% Load Weight
