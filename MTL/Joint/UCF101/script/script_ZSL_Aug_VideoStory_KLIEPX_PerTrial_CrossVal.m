...
model_path = '/import/geb-experiments-archive/Alex/Joint/UCF101/VideoStory/KLIEP_X/Model/';
if ~exist(model_path,'dir')
    mkdir(model_path);
end

perf_path = '/import/geb-experiments-archive/Alex/Joint/UCF101/VideoStory/KLIEP_X/Perf/';
if ~exist(perf_path,'dir')
    mkdir(perf_path);
end

%%% Importance Weighting
weight_model_path = '/import/geb-experiments-archive/Alex/ImportanceWeighting/UCF101/KLIEP_X/Weight/';
