            ...
            for lambdaS = Para.lambdaS_range
                for LatentDim = Para.LatentDim_range
                    for sigmaY = Para.sigma_range
                        ...
                        Perf_Lat = [Perf_Lat;[Para.lambdaD Para.lambdaA Para.lambdaS Para.LatentDim Para.sigmaY AccLat]];
                        fprintf('trial=%d lambdaD=%g lambdaA=%g lambdaS=%g Lat=%d sigma=%g\n latent acc=%.2f\n\n',...
                            trial,Para.lambdaD,Para.lambdaA,Para.lambdaS,Para.LatentDim,Para.sigmaY,100*AccLat);
