...
weight_model_path = '/import/geb-experiments-archive/Alex/ImportanceWeighting/UCF101/KLIEP_XY/Model/';
            ...
            for lambdaS = Para.lambdaS_range
                for LatentDim = Para.LatentDim_range
                    ...
                    model_filepath = sprintf([model_path,...
                        'VideoStory_trial-%d_lambdaD-%g_lambdaA-%g_lambdaS-%g_LatDim-%d_sigX-%g_sigY-%g_aug-1_KLEIPXY_ccv_weight_mth-2.mat'],...
