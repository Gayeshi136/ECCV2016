...
model_path = '/import/geb-experiments-archive/Alex/Joint/HMDB51/VideoStory/KLIEPY/Model/';
...
for trial = 1
    ...
    for sigmaY = Para.sigmaY_range
        ...
        for LatentDim = Para.LatentDim_range
            ...
            perf_filepath = fullfile(perf_path,sprintf('Perf_aug-%d_trial-%d_D-%g_A-%g_S-%g_lat-%d_Y-%g_weight.mat',...
