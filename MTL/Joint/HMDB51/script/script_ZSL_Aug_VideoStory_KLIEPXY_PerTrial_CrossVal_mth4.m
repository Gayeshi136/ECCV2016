            ...
            for lambdaS = Para.lambdaS_range
                for LatentDim = Para.LatentDim_range
                    ...
                    model_filepath = sprintf([model_path,...
                        'VideoStory_trial-%d_lambdaD-%g_lambdaA-%g_lambdaS-%g_LatDim-%d_sigX-%g_sigY-%g_aug-1_KLEIPXY_mth-4.mat'],...
                    ...
                    weight = 1/numel(weight)*ones(size(weight));
                    %% Load Weight
                    ...
                    param.MaxItr = 25;
                    param.epsilon = 5e-3;
                    [Model.D, Model.A , Model.S , Model.L]=func_KernelizedVideoStory_mth3(K,Z,LatentDim,weight,lambdaD,lambdaS,lambdaA,param);
