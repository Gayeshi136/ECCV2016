        ...
        for lambdaA = Para.lambdaA_range
            for lambdaS = Para.lambdaS_range
                for LatentDim = Para.LatentDim_range
                    ...
                    model_filepath = sprintf([model_path,'VideoStory_trial-%d_lambdaD-%g_lambdaA-%g_lambdaS-%g_LatDim-%d_aug-1_KLEIPXY.mat'],trial,lambdaD,lambdaA,lambdaS,LatentDim);
...
%                         continue;
                    ...
                    %% Load weight
                    XYmodel_filepath = sprintf([weight_model_path,'LinearRegress_trial-%d_embed-%s_sigmaX-%g_sigmaY-%g_aug-1_norm-zscore.mat'],trial,Para.EmbeddingMethod,Para.sigmaX,Para.sigmaY);
