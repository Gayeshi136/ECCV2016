...
weight_model_path = '/import/geb-experiments-archive/Alex/ImportanceWeighting/HMDB51/KLIEP_X/Weight/';
        ...
        for lambdaA = Para.lambdaA_range
            for lambdaS = Para.lambdaS_range
                for LatentDim = Para.LatentDim_range
                    ...
                    %% Load weight
                    weight_filepath = sprintf([weight_model_path,'Weight_trial-%d_embed-%s_sigma-%g_aug-1_norm-zscore_ccv.mat'],trial,EmbeddingMethod,Para.sigmaY);
                    temp = load(weight_filepath,'weight');
                    weight = temp.weight;
                    %% Load Weight
