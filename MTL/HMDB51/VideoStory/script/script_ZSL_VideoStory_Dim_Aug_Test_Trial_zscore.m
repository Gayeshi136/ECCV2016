...
for trial = 1:5
    ...
    %                     perf_filepath = fullfile(perf_path,sprintf('Perf_aug-%d_trial-%d_D-%g_A-%g_S-%g_lat-%d_ccv.mat',...
    ...
    model_filepath = sprintf([model_path,...
        'VideoStory_trial-%d_lambdaD-%g_lambdaA-%g_lambdaS-%g_LatDim-%d_aug-%d_norm-zscore_ccv.mat'],trial,Para.lambdaD,Para.lambdaA,Para.lambdaS,Para.LatentDim,Para.DataAug);
