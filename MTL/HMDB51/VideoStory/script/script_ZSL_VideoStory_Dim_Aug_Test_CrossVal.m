...
LatentDim_range = [50 100 125 200 300];
% LatentDim_range = [50 100 125 150 200 300];
    ...
    for lambdaA = lambdaA_range
        for lambdaS = lambdaS_range
            for LatentDim = LatentDim_range
                ...
                fprintf('lambdaD=%g lambdaA=%g lambdaS=%g D=%g acc=%.2f\n',...
                    Para.lambdaD,Para.lambdaA,Para.lambdaS,Para.LatentDim,100*meanAcc);
