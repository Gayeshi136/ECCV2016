...
addpath('/import/geb-experiments/Alex/ECCV16/code/MTL/SharedTools/LRRR/function');
...
for lambda = lambda_range
    ...
    N_L = numel(Para.idx_TrainingSet);
    %% Train GOMTL Model
    
    [Model.S , Model.A , Model.L]=func_Kernelized_LRRR(K,Z,N_L,Para.lambda);
