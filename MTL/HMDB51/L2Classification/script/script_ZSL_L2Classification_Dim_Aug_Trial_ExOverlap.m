...
for trial = 1:50
    ...
    selected_tr_idx = Para.tr_sample_ind'.*idx_HMDB51;
    selected_tr_idx = selected_tr_idx(selected_tr_idx~=0);
    aug_tr_idx = [selected_tr_idx idx_UCF101(exl_idx_UCF101) idx_OlympicSports(exl_idx_OlympicSports) idx_CCV(exl_idx_CCV)];
    
    Z = func_L2Normalization([tr_LabelVec_HMDB51(Para.tr_sample_ind,:) ; tr_LabelVec_UCF101(exl_idx_UCF101,:) ;...
