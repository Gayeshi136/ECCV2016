...
for lambda = lambda_range
    for gamma = gamma_range
        for latent = Latent_range
            ...
            V = func_L2Normalization(Para.phrasevec_mat( Para.idx_TrainingSet,:))';
            ...
            for i = 1:size(V,2)
                idx = find(Para.ClassNoPerVideo(aug_tr_idx)==Para.idx_TrainingSet(i));
                Y(i,idx) = 1;
            end
            ...
            [Model.S , Model.A, Model.L] = func_tr_KernelizedL2Classification_MultiTask(K,V,Y,A0,Para);
