...
for trial = 1:50
    ...
    model_filepath = sprintf([model_path,'L2Classification_trial-%d_embed-%s_lambda-%g_gamma-%g_task-dim_aug-1.mat'],trial,EmbeddingMethod,Para.lambda,Para.gamma);
    ...
    Z = func_L2Normalization([tr_LabelVec_HMDB51(Para.tr_sample_ind,:) ; tr_LabelVec_UCF101 ; tr_LabelVec_OlympicSports ; tr_LabelVec_CCV]);
