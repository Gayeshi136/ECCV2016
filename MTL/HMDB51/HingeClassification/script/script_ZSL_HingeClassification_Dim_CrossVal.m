...
addpath('/import/geb-experiments/Alex/ECCV16/code/MTL/SharedTools/HingeClassification/function');
...
model_path = '/import/geb-experiments-archive/Alex/MTL/HMDB51/HingeClassification/Model/';
if ~exist(model_path,'dir')
    mkdir(model_path);
end

perf_path = '/import/geb-experiments-archive/Alex/MTL/HMDB51/HingeClassification/Perf/';
...
for lambda = lambda_range
    for gamma = gamma_range
        ...
        model_filepath = sprintf([model_path,'HingeClassification_trial-%d_embed-%s_lambda-%g_gamma-%g_task-dim_aug-0.mat'],trial,EmbeddingMethod,Para.lambda,Para.gamma);
...
%             continue;
        ...
        Model.A=func_tr_KernelizedHingeClassification(K,V,Y,Para);
