...
addpath('/import/geb-experiments/Alex/ICCV15/code/SharedTools/GOMTL_L2/function');
    ...
    for lambdaS = lambdaS_range
        for lambdaA = lambdaA_range
            for latent = Latent_range
                ...
                %% Train GOMTL Model
                [Model.S , Model.A , Model.L]=func_KernelizedGOMTL_L2_ncg(K,Z,T,Para.lambdaS,Para.lambdaA);
