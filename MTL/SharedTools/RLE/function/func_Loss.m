...
function [Loss] = func_Loss(A,Data)
...
Loss = -1/(2*Data.N_K)*(sum(sum(Term_AK_SY.*Term_AK_SY))) + Data.lambdaA*trace(A*Data.K*A') + Data.lambdaS*sum(abs(Data.S(:)));
