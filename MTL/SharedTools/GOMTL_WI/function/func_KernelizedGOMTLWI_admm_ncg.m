...
function [S,A,Loss_full]=func_KernelizedGOMTLWI_admm_ncg(K,Y,L,Para)
...
lambdaS = Para.lambdaS;
lambdaA = Para.lambdaA;
SpreadCoeff = Para.SpreadCoeff;
...
%% Reweight Instance
K = sparse(1:N_K,1:N_K,Para.AugInstanceWeight)*K;
Y = Y*sparse(1:N_K,1:N_K,Para.AugInstanceWeight);
