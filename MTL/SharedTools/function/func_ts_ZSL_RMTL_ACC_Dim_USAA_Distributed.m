...
function [meanAcc,Accuracy] = func_ts_ZSL_RMTL_ACC_Dim_USAA_Distributed(Para,Model)
...
S_ts = (repmat(A0,size(At_bar,1),1)+At_bar)*D_CCV(Para.aug_tr_idx,Para.selected_ts_idx);   %D(selected_ts_idx,aug_tr_idx) * A;
S_ts = zscore(S_ts');
