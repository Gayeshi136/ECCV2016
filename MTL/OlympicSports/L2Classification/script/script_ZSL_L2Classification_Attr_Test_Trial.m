...
lambda_range = [1e1 5e0 1e0 1e-1 1e-2 1e-3];
gamma_range = [1e1 5e0 1e0 1e-1 1e-2 1e-3];
...
for trial = 1:50
    ...
    [meanAcc,Accuracy] = func_ts_ZSL_KernelizedL2Classification_MAP(K_te,V_te,Y_GT,Para,Model);
