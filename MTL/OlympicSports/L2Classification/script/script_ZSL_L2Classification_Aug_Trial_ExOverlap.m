...
%     aug_tr_idx = [idx_HMDB51 idx_UCF101 selected_tr_idx   idx_CCV];
    ...
    Z = func_L2Normalization([tr_LabelVec_HMDB51(exl_idx_HMDB51,:); tr_LabelVec_UCF101(exl_idx_UCF101,:);...
        tr_LabelVec_OlympicSports(Para.tr_sample_ind,:) ; tr_LabelVec_CCV(exl_idx_CCV,:)]);
       
    %     Z = func_L2Normalization([tr_LabelVec_HMDB51; tr_LabelVec_UCF101 ; tr_LabelVec_OlympicSports(Para.tr_sample_ind,:)  ; tr_LabelVec_CCV]);
