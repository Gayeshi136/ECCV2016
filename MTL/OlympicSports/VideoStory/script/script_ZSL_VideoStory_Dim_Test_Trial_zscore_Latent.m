...
for trial = 1:50
    ...
    if ~exist(model_filepath,'file')
        ...
        temp = func_LoadVideoStoryModel(model_filepath);
%         catch
...
%         end
    ...
    %% Load Data Split
    param.zeroshot_datasplit_path = zeroshot_datasplit_path;
    param.perc_TrainingSet = perc_TrainingSet;
    param.perc_TestingSet = perc_TestingSet;
    param.trial = trial;
    [Para.idx_TrainingSet, Para.idx_TestingSet] =func_LoadDataSplit(param);
