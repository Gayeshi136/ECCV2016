...
trial = 1;
EmbeddingMethod = 'add';
lambda0_range = [1e-4 1e-3 1e-2 1e-1];
lambdat_range = [1e-4 1e-3 1e-2 1e-1];
alpha = 0.2;
Para.SelfTraining = 0;
...
for trial = 1:50
    ...
    model_filepath = sprintf([model_path,'RMTL_trial-%d_lambda0-%g_lambdat-%g_aug-0.mat'],trial,Para.lambda0,Para.lambdat);
