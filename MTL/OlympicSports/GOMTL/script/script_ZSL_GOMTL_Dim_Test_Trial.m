...
for trial = 1:50
    ...
    %% Test GOMTL Model
    [mAP,AP] = func_ts_ZSL_GOMTL_MAP_Dim_Embed(Para,Model);
    LatentTrialMAP(trial) = mAP;
    
    [mAP,AP] = func_ts_ZSL_GOMTL_MAP_Dim(Para,Model);
    DistributedTrialMAP(trial) = mAP;
...
mean(DistributedTrialMAP)
std(DistributedTrialMAP)