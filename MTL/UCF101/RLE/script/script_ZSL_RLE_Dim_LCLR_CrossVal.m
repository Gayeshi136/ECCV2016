...
addpath('/import/geb-experiments/Alex/ECCV16/code/MTL/SharedTools/RLE/function');
...
LatentProportion_range = [0.05 0.1 0.2];
alpha = 0.2;
Para.SelfTraining = 0;
...
model_path = '/import/geb-experiments-archive/Alex/MTL/UCF101/RLE_ICLR/Model/';
if ~exist(model_path,'dir')
    mkdir(model_path);
end

perf_path = '/import/geb-experiments-archive/Alex/MTL/UCF101/RLE_ICLR/Perf/';
...
%                 fclose(fid);
            ...
            [Model.S , Model.A , Model.L]=func_KernelizedRLE_ICLR(K,Z,N_L,Para.lambdaS,Para.lambdaA);
