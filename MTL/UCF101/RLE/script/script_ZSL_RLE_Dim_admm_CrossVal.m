...
model_path = '/import/geb-experiments-archive/Alex/MTL/UCF101/RLE/Model/';
if ~exist(model_path,'dir')
    mkdir(model_path);
end

perf_path = '/import/geb-experiments-archive/Alex/MTL/UCF101/RLE/Perf/';
...
for lambdaS = lambdaS_range
    for lambdaA = lambdaA_range
        for prop = LatentProportion_range
            ...
            [Model.S , Model.A , Model.L]=func_KernelizedRLE_admm(K,Z,N_L,Para.lambdaS,Para.lambdaA);
