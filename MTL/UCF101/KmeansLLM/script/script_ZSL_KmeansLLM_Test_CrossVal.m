...
addpath('/import/geb-experiments/Alex/ECCV16/code/MTL/SharedTools/KmeansLLM/function');
...
LatentProportion_range = [0.02 0.05 0.08 0.1 0.2 0.5];
NumLLM_range = 1:10;
...
for NumLLM = NumLLM_range
    ...
    %% Test GOMTL Model
    [meanAcc,Acc] = func_ts_ZSL_KmeansLLM(Para,Model);
    
    Perf = [Perf;{Para.lambda Para.NumLLM meanAcc}];
