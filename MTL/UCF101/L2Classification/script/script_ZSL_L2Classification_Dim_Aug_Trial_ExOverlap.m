...
for trial = 1:50
    ...
    %     Z = func_L2Normalization([tr_LabelVec_HMDB51; tr_LabelVec_UCF101(Para.tr_sample_ind,:)   ; tr_LabelVec_OlympicSports ; tr_LabelVec_CCV]);
    Z = func_L2Normalization([tr_LabelVec_HMDB51(exl_idx_HMDB51,:); tr_LabelVec_UCF101(Para.tr_sample_ind,:)  ;...
        tr_LabelVec_OlympicSports(exl_idx_OlympicSports,:) ; tr_LabelVec_CCV(exl_idx_CCV,:)]);
