...
for trial = 1:5
    ...
    model_filepath = sprintf([model_path,'VideoStory_trial-%d_lambdaD-%g_lambdaA-%g_lambdaS-%g_LatDim-%d_aug-%d_norm-zscore.mat'],...
        trial,Para.lambdaD,Para.lambdaA,Para.lambdaS,Para.LatentDim,Para.DataAugmentaiton);
