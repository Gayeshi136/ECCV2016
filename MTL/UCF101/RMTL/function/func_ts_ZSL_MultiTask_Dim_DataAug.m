...
function [meanAcc,Accuracy] = func_ts_ZSL_MultiTask_Dim_DataAug(Para,Model)
...
S_ts = (repmat(A0,size(At_bar,1),1)+At_bar)*D(aug_tr_idx,selected_ts_idx);   %D(selected_ts_idx,aug_tr_idx) * A;
