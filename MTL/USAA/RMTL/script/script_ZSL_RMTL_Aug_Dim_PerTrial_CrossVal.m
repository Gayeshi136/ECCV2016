...
trial = 1;
EmbeddingMethod = 'add';
lambda0_range = [1e-4 1e-3 1e-2];
lambdat_range = [1e-4 1e-3 1e-2];
alpha = 0.2;
Para.SelfTraining = 0;
...
%             S = [tr_LabelVec_HMDB51 ; tr_LabelVec_UCF101 ; tr_LabelVec_OlympicSports ; tr_LabelVec];
            ...
            Para.Z = Z_all(train_video_label(ismember(train_video_label,idx_TrainingSet)),:)';            
            Para.aug_tr_idx =selected_tr_idx;

            
            Model = func_tr_ZSL_RMTL_Dim_USAA_zscore(Para);
