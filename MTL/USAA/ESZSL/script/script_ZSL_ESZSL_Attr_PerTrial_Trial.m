...
%             attr = [train_attr ; test_attr];
%             video_label = [train_video_label ; test_video_label];
%             for c_i = 1:8
%                 phrasevec_mat(c_i,:) = mean(attr(video_label==c_i,:),1)>0.5;
%             end
%             prototype_annotations = phrasevec_mat(idx_TestingSet,:);
